...
def app4():
    ...
    ibsoja1 = psoja1*dol*rinde*cantidad
    ibsoja2 = psoja2*dol*rinde*cantidad
    ibtrigo = ptrigo*dol*rinde*cantidad
    ibmaiz = pmaiz*dol*rinde*cantidad
    ibgirasol = pgirasol*dol*rinde*cantidad
